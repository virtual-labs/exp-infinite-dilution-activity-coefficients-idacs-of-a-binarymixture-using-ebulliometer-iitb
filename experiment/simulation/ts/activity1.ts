...
function load_higlighted_images() {
	...
	a1_labels = [
		new Chemistry.Text(
			'Dimmer Stat',
			new Chemistry.Point(600, 280),
			canvas
		),

		new Chemistry.Text(
			'Heating Tap',
			new Chemistry.Point(1450, 280),
			canvas
		),
		...
		new Chemistry.Text(
			...
			new Chemistry.Point(150, 330),
			canvas
		),

		new Chemistry.Text(
			'Ebulliometer',
			new Chemistry.Point(550, 780),
			canvas
		),
	];
